...
regtab_fun(r1) %>%
  ...
  row_spec(1:nrow(regtab_fun(r1)), color = "black")
```
...
#   kable(align = c(rep("r", ncol(.) - 1), "l")) %>%
#   kable_styling(font_size = 16) %>%
#   row_spec(1:nrow(regtab_ran_fun(r1)), color = "black")
```

## Bayesian regression

RESUME WORKING ON THIS LATER - currently errors due to MacOS Catalina
...
regtab_fun(r1_bayes) %>%
  ...
  kable_styling(font_size = 16) %>%
  row_spec(2, bold = T) %>%
  row_spec(1:nrow(regtab_fun(r1_bayes)), color = "black")
```
...
#   kable(align = "r") %>%
#   kable_styling(font_size = 16) %>%
#   row_spec(1:nrow(regtab_ran_fun(r1_bayes)), color = "black")
```
...
regtab_fun(r2) %>%
  kable(align = c(rep("r", ncol(.) - 1), "l")) %>%
  kable_styling(font_size = 16) %>%
  row_spec(1:nrow(regtab_fun(r2)), color = "black")
```
...
#   kable(align = c(rep("r", ncol(.) - 1), "l")) %>%
#   kable_styling(font_size = 16) %>%
#   row_spec(1:nrow(regtab_ran_fun(r2)), color = "black")
```
...
regtab_fun(r3) %>%
  kable(align = c(rep("r", ncol(.) - 1), "l")) %>%
  kable_styling(font_size = 16) %>%
  row_spec(1:nrow(regtab_fun(r3)), color = "black")
```
...
#   kable(align = c(rep("r", ncol(.) - 1), "l")) %>%
#   kable_styling(font_size = 16) %>%
#   row_spec(1:nrow(regtab_ran_fun(r3)), color = "black")
```
