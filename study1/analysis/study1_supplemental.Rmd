...
```{r}
regtab_fun(rr1, por_name = "Porosity Vignettes") %>% 
...
```{r}
regtab_fun(rr1a, por_name = "Porosity Vignettes") %>% 
  regtab_style_fun(row_emph = 2:3)
```
...
```{r}
regtab_fun(rr1b, por_name = "Porosity Vignettes") %>% 
  regtab_style_fun(row_emph = 2:3)
```
...
```{r}
regtab_fun(rr1_bayes, por_name = "Porosity Vignettes") %>% 
  regtab_style_fun(row_emph = 2:3)
```
...
```{r}
regtab_fun(rr1a_bayes, por_name = "Porosity Vignettes") %>% 
  regtab_style_fun(row_emph = 2:3)
```
...
```{r}
regtab_fun(rr1b_bayes, por_name = "Porosity Vignettes") %>% 
  regtab_style_fun(row_emph = 2:3)
```
...
```{r}
regtab_fun(rr2, por_name = "Porosity Vignettes") %>% 
  regtab_style_fun(row_emph = 2:3)
```
